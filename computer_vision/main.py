...
def print_hi(name):
    ...
    img00 = cv2.imread('images/labrador-retriever-1.jpg', 0)  # labrador-retriever-1
    img01 = cv2.imread('images/labrador-retriever-2.jpg', 0)

    # img1 = cv2.imread('images/labrador-retriever-1.jpg', 0)  # 714 x 901 pixels
    # img2 = cv2.imread('images/labrador-retriever-2.jpg', 0)  # 714 x 901 pixels
